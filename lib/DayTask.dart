...
import 'package:habit_21_1/Data.dart';
      ...
      body: Column(
        children: <Widget>[
          Expanded(
            ...
            child: Center(
              child: 
              (!widget.isCustom)?Text(habitMap['${widget.habitName}'].elementAt(widget.index-1),style: TextStyle(color: Colors.white),):
              (widget.taskDes != " ")
                  ? Text(widget.taskDes, style: TextStyle(color: Colors.white))
